...
export const getRequirements = (inventory, output) => {
	...
	let requirements = {};
	requirements = addItemResult(requirements, TORSTOL, requiredTorstol, "Overload");
	
	requirements = addItemResult(requirements, AVANTOE, requiredAvantoe, "Extreme Attack");
	requirements = addItemResult(requirements, DWARF_WEED, requiredDwarfWeedForExtremeStrength, "Extreme Strength");
	requirements = addItemResult(requirements, DWARF_WEED, requiredDwarfWeedForSuperRanging, "Super Ranging Potion");
	requirements = addItemResult(requirements, LANTADYME, requiredLantadymeForExtremeDefence, "Extreme Defence");
	requirements = addItemResult(requirements, LANTADYME, requiredLantadymeForSuperMagic, "Super Magic");
	requirements = addItemResult(requirements, IRIT, requiredIrit, "Super Attack");
	requirements = addItemResult(requirements, KWUARM, requiredKwuarm, "Super Strength");
	requirements = addItemResult(requirements, CADANTINE, requiredCadantine, "Super Defence");
	requirements = addItemResult(requirements, RANARR, requiredRanarr, "Prayer Potion");
	requirements = addItemResult(requirements, FELLSTALK, requiredFellstalk, "Prayer Renewal");
	requirements = addItemResult(requirements, TOADFLAX, requiredToadflax, "Saradomin Brew");
	requirements = addItemResult(requirements, SNAPDRAGON, requiredSnapdragon, "Super Restore");
	requirements = addItemResult(requirements, SPIRIT_WEED, requiredSpritWeed, "Summoning Potion");
	
	requirements = addItemResult(requirements, GROUND_MUD_RUNES, requiredGroundMudRunes, "Extreme Magic");
	requirements = addItemResult(requirements, GRENWALL_SPIKES, requiredGrenwallSpikes, "Extreme Ranging");
	requirements = addItemResult(requirements, EYE_OF_NEWT, requiredEyeOfNewt, "Super Attack");
	...
	requirements = addItemResult(requirements, RED_SPIDER_EGGS, requiredRedSpiderEggs, "Super Restores");
	requirements = addItemResult(requirements, MORCHELLA_MUSHROOM, requiredMorchellaMushroom, "Prayer Renewal");
